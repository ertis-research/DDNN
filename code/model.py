...
def create_model( img_height, img_width, num_classes ):
    ...
    layer_dropout1 = layers.Dropout(0.3)(layer_maxpooling1)
    ...
    layer_dropout2 = layers.Dropout(0.2)(layer_maxpooling2)
    ...
    layer_dropout5 = layers.Dropout(0.15)(layer_maxpooling5)
    ...
    layer_dense3 = layers.Dense(4096, activation='relu')(layer_flatten2)
    layer_batchN8 = layers.BatchNormalization()(layer_dense3)
    layer_dropout8 = layers.Dropout(0.1)(layer_batchN8)
